  ...
  <div class="row">
    <div class="col-12">
      ...
      <form>
        ...
        />
        <button class="btn btn-success" type="button" @click="addMethod()">Add Method</button>
        <br />
      </form>
    </div>
    ...
    <div class="col-6">
      <textarea
        class="bg-dark col pt-3 text-white"
        name="exampleBox"
        id="exampleBox"
        rows="15"
        v-model="example"
    ...
    return {
      ...
      arrayMethods: [
        ...
        },
        {
          name: "entries",
          method:
            "returns a new array iterator object with key/value pairs for each element",
          methodExample:
        ...
        },
        {
          name: "find",
          method:
            "returns value of first element that matches the provided function",
          methodExample:
        ...
        },
        {
          name: "isArray",
          method:
            "checks whether the passed value is an array and returns true or false",
          methodExample:
        ...
        },
        {
          ...
          methodExample:
            'let array1 = [1, 2, 3]\r\rarray1.join(" ")\r\r//output: 1 2 3'
        },
        {
          name: "lastIndexOf",
          method:
        ...
        },
        {
          name: "map",
          method:
            "this creates a new array with the results of the given function",
          methodExample:
        ...
        },
        {
          name: "reduce",
          method:
            "reduces an array to a single value using a reductor function",
          methodExample:
